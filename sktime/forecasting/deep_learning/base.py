# -*- coding: utf-8 -*-
"""
Abstract base class for the Keras neural network forecasters.

The reason for this class between BaseForecaster and deep_learning forecasters is
...
class BaseDeepForecaster(BaseForecaster, ABC):
    """Abstract base class for deep learning time series classifiers.

    The base forecaster provides a deep learning default method for
    ...
    def __init__(self, batch_size=40, random_state=0):
        self.batch_size = batch_size
        self.random_state = random_state
        self.model_ = None
        super(BaseDeepForecaster, self).__init__()
